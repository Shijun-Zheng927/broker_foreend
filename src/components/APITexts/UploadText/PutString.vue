    ...
    <template v-slot:form>
      <el-form label-position="left" label-width="150px" :model="formData">
        ...
        <el-form-item label="目标存储路径">
          <el-input v-model="formData.objectPath" placeholder="b.txt"></el-input>
        </el-form-item>
        <el-form-item label="内容">
          <el-input v-model="formData.content" placeholder="this is a test"></el-input>
        </el-form-item>
      </el-form>
    </template>
...
export default {
  ...
  methods:{
    send(){
      this.axios.post('/putString',this.formData).then((res)=>{
