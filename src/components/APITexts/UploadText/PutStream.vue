    ...
    <template v-slot:form>
      <el-form label-position="left" label-width="150px" :model="formData">
        ...
        <el-form-item label="目标存储路径">
          <el-input v-model="formData.objectPath" placeholder="baidu"></el-input>
        </el-form-item>
        <el-form-item label="网页流网址">
          <el-input v-model="formData.inputUrl" placeholder="http://www.baidu.com"></el-input>
        </el-form-item>
      </el-form>
    </template>
...
export default {
  ...
  methods:{
    send(){
      this.axios.post('/putStream',this.formData).then((res)=>{
