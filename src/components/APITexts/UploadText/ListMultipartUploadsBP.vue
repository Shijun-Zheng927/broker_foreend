  ...
  <api-template>
    ...
    <template v-slot:form>
      <el-form label-position="left" label-width="150px" :model="formData">
        ...
        <el-form-item label="每页最大分片事件数">
          <el-input v-model="formData.maxUploads" placeholder="10"></el-input>
        </el-form-item>
      </el-form>
    </template>
...
export default {
  ...
  methods:{
    send(){
      this.axios.post('/listMultipartUploadsByPapper',this.formData).then((res)=>{
