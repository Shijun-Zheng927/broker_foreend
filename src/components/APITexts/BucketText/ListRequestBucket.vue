    ...
    <template v-slot:form>
      <el-form label-position="left" label-width="150px" :model="formData">
        ...
        <el-form-item label="起始">
          <el-input v-model="formData.market" placeholder="1"></el-input>
        </el-form-item>
        <el-form-item label="最大值">
          <el-input v-model="formData.maxKeys" placeholder="5"></el-input>
        </el-form-item>
      </el-form>
    </template>
...
export default {
  ...
  methods:{
    send(){
      this.axios.post('/listRequestBucket',this.formData).then((res)=>{
