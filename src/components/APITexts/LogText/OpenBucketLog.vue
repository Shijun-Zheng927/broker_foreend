  ...
  <api-template>
    ...
    <template v-slot:form>
      <el-form label-position="left" label-width="150px" :model="formData">
        <el-form-item label="目标桶名称">
          <el-input v-model="formData.logBucketName" placeholder="xmsx-003"></el-input>
        </el-form-item>
        <el-form-item label="源桶名称">
          <el-input v-model="formData.bucketName" placeholder="xmsx-003"></el-input>
        </el-form-item>
        <el-form-item label="日志路径">
          <el-input v-model="formData.logpath" placeholder="zzzlog/"></el-input>
        </el-form-item>
      </el-form>
    </template>
...
export default {
  ...
  methods:{
    send(){
      this.axios.post('/openBucketLogging',this.formData).then((res)=>{
