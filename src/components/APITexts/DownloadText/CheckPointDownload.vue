    ...
    <template v-slot:form>
      <el-form label-position="left" label-width="150px" :model="formData">
        ...
        <el-form-item label="分段大小">
          <el-input v-model="formData.partSize" placeholder="4000000"></el-input>
        </el-form-item>
        <el-form-item label="下载时的最大并发数">
          <el-input v-model="formData.taskNum" placeholder="5"></el-input>
        </el-form-item>
      </el-form>
    </template>
...
export default {
  ...
  methods:{
    send(){
      this.axios.post('/checkPointDownload',this.formData).then((res)=>{
